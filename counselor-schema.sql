...
-- Ensure user_stats has the narrative summary + grade the route reads.
-- (user_stats is this app's per-user profile table, keyed by user_id. The
-- grade column also drives the grade-gated Foundations nav link.)
