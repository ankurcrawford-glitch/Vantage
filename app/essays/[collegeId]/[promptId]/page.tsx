...
export default function EssayWritingPage() {
  ...
  // Focused guidance — an optional lens the user picks before hitting
  // Get Guidance. Passes through as `focusDirective` in the API body.
            ...
            <div>
              <h1 className="font-heading text-4xl mb-2" style={{ color: '#E8DDC9' }}>
                ...
                {collegeId === 'a0000000-0000-0000-0000-000000000000' && (
                  <span className="font-body text-base" style={{ color: 'rgba(232,221,201,0.45)', fontWeight: 400, marginLeft: '12px', letterSpacing: '0.05em' }}>
                    2026–27
                  </span>
                )}
              </h1>
...
// Preset lenses for Strategic Intelligence. Turns a single "Get
// Guidance" CTA into a directed review — the student picks the specific
// worry they have, or leaves it as general. Chips are toggleable; a
// second click clears the selection. Custom text input lets the student
// name a concern in their own words when none of the presets fit.
...
// Quiet indicator for the autosave state. Lives next to the word
// count. Subtle so it doesn't compete with the writing — students
// notice "Saved 12s ago" only if they're worried; the green "Saved"
// pulse is what reassures everyone else.
