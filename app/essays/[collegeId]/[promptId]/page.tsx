...
export default function EssayWritingPage() {
  ...
  const handleSendInvitation = async () => {
    ...
    try {
      ...
      const invitationLink = `${window.location.origin}/invitations/${data.token}`;
      
      alert(`Invitation sent! Share this link: ${invitationLink}\n\n(You can copy this link and send it to ${newInvitation.email})`);
